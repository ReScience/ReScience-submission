...
```{r coord-id, eval=TRUE, fig.align='right', fig.height=4, fig.width=6, cache=TRUE, autodep=TRUE, dev='png'}
library(irlgraph)
...
```{r print-mesh, eval=TRUE, fig.align='left', fig.height=3.2, fig.width=3.2, dev='png'}
par(mar=c(2,0,0,0))
...
```{r acc_cost, eval=TRUE, fig.align='right', fig.height=4, fig.width=6, dev='png',cache=TRUE,dependson='coord-id'}
...
```{r impute_na, eval=TRUE, fig.align='right', fig.height=4, fig.width=6, dev='png'}
...
```{r processing_speed_1, eval=TRUE, fig.align='left', fig.height=3.2, fig.width=4.6, dev='png'}
...
```{r processing_speed_2, eval=TRUE, fig.align='left', fig.height=3.2, fig.width=4.6, dev='png'}
...
```{r directional_bias, eval=TRUE, fig.align='left', fig.height=2.9, fig.width=6.4, dev='png'}
library(raster)
library(ggplot2)
