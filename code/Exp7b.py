...
# File description:
#
# As Exp7a with the difference that generation of the input is adjusted to
# exactly reproduce the curve shown in the original publication
# (by reducing the input time constant after stimulus offset).
# -----------------------------------------------------------------------------
...
for s in range(0, 2):
    ...
    # simulate post-stimulus period (change tau)
