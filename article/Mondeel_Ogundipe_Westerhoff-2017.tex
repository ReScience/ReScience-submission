...
the biomarker prediction algorithm.}\label{fig:Shlomi2009_figure_3}
\end{figure}

Figure 3 in the original publication entailed an in-depth look at the
results highlighted in Figure 2 for methionine metabolism. We reproduced
this Figure as Figure ~\ref{fig:Shlomi2009_figure_3}. The numerical
results illustrated in ~\ref{fig:Shlomi2009_figure_3}B may be reproduced
using the notebook `Reproduce\_figure2\_Shlomi2009', the detailed
results may be inspected using the last cell of that notebook. We note
that in the original publication the WT interval for the CBS IEM was
drawn as an interval whereas our results indicate an interval of
\([-1,-1]\).
