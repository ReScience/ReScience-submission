...
\begin{figure}[!htbp]
    ...
    plotted against ({\bfseries \sffamily A}) the one generated by \emph{Adams}
    method and ({\bfseries \sffamily B}) \emph{BDF} method.}
    \label{Fig:1}
\end{figure}
...
using the reference implementation code. 
%%
\begin{figure}[!htbp]
