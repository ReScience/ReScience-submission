...
# -----------------------------------------------------------------------------
# A script that runs the noise exploration simulations of the replication study.
#
# -----------------------------------------------------------------------------
...
for A in As:
    for drive_frequency in frequencies:
        ...
        for i,seed in enumerate(seeds):
            ...
            filename_ctrl  = '/Single-Trial-Data-'+str(int(drive_frequency))+'Hz/sims_ctrl_'+str(int(drive_frequency))+'Hz_A'+str(A)+'_'+str(i)
            filename_schiz = '/Single-Trial-Data-'+str(int(drive_frequency))+'Hz/sims_schiz_'+str(int(drive_frequency))+'Hz_A'+str(A)+'_'+str(i)
        ...
        filename_ctrl_avg = directory+'/Data-Average/sims_ctrl_avg_'+str(int(drive_frequency))+'Hz_A'+str(A)
        filename_schiz_avg = directory+'/Data-Average/sims_schiz_avg_'+str(int(drive_frequency))+'Hz_A'+str(A)
