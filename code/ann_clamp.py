...
"""
Python script to reproduce the voltage clamp expirement.
...
#------------------------------------------------------------------------------#
# learnin rule for voltage clamp experiment as mentioned in the original publication
equatSTDP_clamp = """
...
def run():
    ...
    compile()
    # postsynaptic membrane potential are set fix from -80mV to 0mV
