...
*/
std::vector< Name > nest::compte2003_in::comp_names_( NCOMP );
...
// DictionaryDatum nest::compte2003_in::receptor_dict_ = new Dictionary();
...
{
//compartment 0
  insert_(Name("V_m.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::V_M,compte2003_in::comp_0>);
  insert_(Name("n_Ca.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::n_Ca,compte2003_in::comp_0>);
  insert_(Name("n_Na.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::n_Na,compte2003_in::comp_0>);
  insert_(Name("Na_h.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::Na_h,compte2003_in::comp_0>);
  insert_(Name("K_m.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_m,compte2003_in::comp_0>);
  insert_(Name("K_s_m.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_s_m,compte2003_in::comp_0>);
  insert_(Name("K_A_h.0"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_A_h,compte2003_in::comp_0>);
  insert_(Name("g_ampa.0"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_AMPA,compte2003_in::comp_0>);
  insert_(Name("g_nmda_fast.0"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_NMDA_FAST,compte2003_in::comp_0>);
  insert_(Name("g_nmda_slow.0"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_NMDA_SLOW,compte2003_in::comp_0>);
  insert_(Name("g_gaba.0"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_GABA,compte2003_in::comp_0>);

  //compartment 1
  insert_(Name("V_m.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::V_M,compte2003_in::comp_1>);
  insert_(Name("n_Ca.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::n_Ca,compte2003_in::comp_1>);
  insert_(Name("n_Na.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::n_Na,compte2003_in::comp_1>);
  insert_(Name("Na_h.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::Na_h,compte2003_in::comp_1>);
  insert_(Name("K_m.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_m,compte2003_in::comp_1>);
  insert_(Name("K_s_m.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_s_m,compte2003_in::comp_1>);
  insert_(Name("K_A_h.1"), &compte2003_in::get_y_elem_<compte2003_in::State_::K_A_h,compte2003_in::comp_1>);
  insert_(Name("g_ampa.1"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_AMPA,compte2003_in::comp_1>);
  insert_(Name("g_nmda_fast.1"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_NMDA_FAST,compte2003_in::comp_1>);
  insert_(Name("g_nmda_slow.1"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_NMDA_SLOW,compte2003_in::comp_1>);
  insert_(Name("g_gaba.1"),&compte2003_in::get_y_elem_<compte2003_in::State_::G_GABA,compte2003_in::comp_1>);
...
nest::compte2003_in::Parameters_::Parameters_(const Parameters_& p)
  : t_ref (p.t_ref),
    E_ex  (p.E_ex),
    E_in  (p.E_in),
    E_Na  (p.E_Na),
...
nest::compte2003_in::Parameters_& nest::compte2003_in::Parameters_::operator=(const Parameters_& p)
{
...
void nest::compte2003_in::calibrate()
{
...
void
nest::compte2003_in::update( Time const& origin, const long_t from, const long_t to )
{
