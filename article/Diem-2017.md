...
* (23) Both $J_{TRPV}$ and $J_{Ca}$ should have positive signs, such that it reads $\frac{d \left[ Ca\textsuperscript{2+} \right] }{dt} = J_{TRPV} + J_{Ca} - Ca_{decay} \left( \left[ Ca\textsuperscript{2+} \right]_p - \left[ Ca\textsuperscript{2+} \right]_{p,0} \right)$.
...
* Parameter $k_{Ca} = 1.3568e2$ 1/s is incorrectly cited from [@Gonzalez1994]
