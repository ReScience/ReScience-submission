...
# Fig 5b)
fig5b = plot(sim2[:,1],sim2[:,2], label="Hosts", frame=:origin, lw=3, leg=false)
...
# Fig 5c)
fig5c = plot(sim3[:,1],sim3[:,2], label="Hosts", frame=:origin, lw=3, leg=false)
...
plot(fig5a, fig5b, fig5c, fig5d, fig5e, fig5f, layout=(2,3), size=(1200,900), margin=1cm)
