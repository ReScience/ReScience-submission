...
![Effect of the vasodilatory drug pinacidil on the results. Radial strain appears to be a good match, although its increase starts later compared to the results in the original publication. The values for perivascular calcium are much higher than in the original publication, but the reason for this could not be found. Simulation tolerance values atol=1e-7, rtol=1e-7.](figures/pinacidil_2000uM.png){#fig:pinacidil}
