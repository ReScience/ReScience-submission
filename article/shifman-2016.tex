...
had a slightly different parameter set.

It is important to note however that this in no way detracts from the
results of the original manuscript - the only difference is in subtle
features. The major results: replication of frequency adaptations,
parametric variation, etc\ldots{} are all replicated despite these
discrepancies.
